...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_owner(user):
        ...
        return
    await update.message.reply_text("پیام ناشناس خود را ارسال کنید (متن، عکس، ویدیو، فایل، آهنگ، گیف، استیکر):")
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if msg.text:
            ...
            await context.bot.send_message(chat_id=OWNER_CHAT_ID, text=prefix + "[استیکر]", reply_markup=reply_kb(uid))
            ...
            await context.bot.send_message(chat_id=OWNER_CHAT_ID, text=prefix + "[ویدیو نوت]", reply_markup=reply_kb(uid))
...
async def send_reply(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if msg.text:
            await context.bot.send_message(chat_id=sender_id, text="پاسخ: " + msg.text)
        elif msg.photo:
